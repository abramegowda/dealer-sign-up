...
(function(factory) {
  ...
  $.fn.dateRangePicker = function(opt) {
    ...
    function createDom() {
      ...
      var arrowPrev = "<img class='cal-arrow' src='images/chevron-left.png'>";
      if (opt.customArrowPrevSymbol) arrowPrev = opt.customArrowPrevSymbol;

      var arrowNext = "<img class='cal-arrow' src='images/chevron-right.png'>";
      ...
      html +=
        ...
        '           <tr class="caption">' +
        "               <th colspan='7'>" +
        '<div class="month-arrow-combined">' +
        '                   <span class="prev">' +
        arrowPrev +
        "                   </span>" +
        ...
        : "") +
        '<span class="reset"><img class="reset-icon" src="images/reset.png">Reset</span>'+
        '</div>'+
        "               </th>" +
        "           </tr>" +
        '           <tr class="week-name">' +
